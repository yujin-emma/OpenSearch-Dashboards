...
- [Multiple Datasource] Add switch to default data source button for DataSourceView([#6610](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/6610))
